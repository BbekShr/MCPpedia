        ...
        <section>
          ...
          <div className="border border-border rounded-md overflow-hidden">
            <table className="w-full text-sm">
              ...
              <tbody>
                <tr className="border-t border-border"><td className="px-3 py-2 font-medium">Known CVEs</td><td className="px-3 py-2 text-text-muted">Open vulnerabilities from OSV.dev. Critical/high: -5 each, medium: -3, low: -1, unrated: -3. Severity comes from the CVSS 3.1 base score, else the advisory publisher&apos;s own rating, else the CVSS 4.0 vector; an open advisory with none of those (malicious-package reports, for instance) counts as unrated rather than harmless.</td><td className="px-3 py-2 text-right">15</td></tr>
