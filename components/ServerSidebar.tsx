      ...
      <div className="sticky top-20 space-y-5">
        ...
        <div className="border border-border rounded-md p-4">
          ...
          <div className="space-y-1.5">
            {s.github_url && (
              <a href={s.github_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-text-muted hover:text-text-primary">
            ...
            {s.homepage_url && (
              <a href={s.homepage_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-text-muted hover:text-text-primary">
