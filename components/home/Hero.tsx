    ...
    <>
      <section className="relative" style={{ background: 'var(--hero-gradient)' }}>
        <div className="relative max-w-[960px] mx-auto px-4 md:px-6 pt-16 md:pt-[72px] pb-12 md:pb-14 text-center">
          <div
            className="hero-rise hero-rise-1 inline-flex items-center gap-2 mb-4 px-2.5 py-1 rounded-full text-xs text-text-muted backdrop-blur"
            style={{
          ...
          <h1 className="hero-rise hero-rise-2 m-0 text-4xl md:text-5xl font-bold text-text-primary tracking-tight leading-[1.1]">
            Find an MCP server
            <br />
            <span className="text-accent">you can actually trust.</span>
          </h1>

          <p className="hero-rise hero-rise-2 mt-4 mx-auto max-w-[560px] text-base md:text-lg text-text-muted">
      ...
      {/* Deliberately outside the hero section. The hero is the value prop plus
          the primary action; a trust strip stacked inside it pushes the search
          box down and turns one moment into a list. */}
