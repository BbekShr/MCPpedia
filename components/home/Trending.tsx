...
function Row({ row, rank }: { row: TrendingRow; rank: number }) {
  ...
  return (
    <Link
      href={`/s/${row.slug}`}
      className="trend-row grid gap-3 px-3 py-2.5 items-center text-[13px] text-text-primary"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <span
          ...
          style={{ fontSize: 12, color: gradeColor(score), minWidth: 26 }}
        >
          {score}
        </span>
      </div>
  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto px-4 md:px-6">
        ...
        <div
          className="font-mono grid gap-3 px-3 py-2 text-[10.5px] uppercase tracking-widest text-text-muted font-medium"
          style={{
            gridTemplateColumns: '28px 1.6fr 1fr 160px 120px',
